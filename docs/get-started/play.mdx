...
This means that both teams will bet 210EXEs, the smaller amount between the two. So, player's C and D will have to reduce their bet amounts. This is done automatically, while keeping the ratio:

- **Player C** has 68.75% (220/320 x 100) of their team's bet so their bet will be `210 x 0.6875 = 144EXEs`
- **Player D** has 31.25% (100/320 x 100) of their team's bet so their bet will be `210 x 0.3125 = 66EXEs`
